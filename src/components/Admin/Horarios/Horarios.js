...
import { updateHorarioApi, activateHorarioApi, deleteHorarioApi } from "../../../api/horarios";
      ...
      <div className="horario-list">
         <div className="horario-list__header">
            <div>
               <h4>Horarios</h4>
               <ul>
                  <li>Para ordenar: seleccione un horario y arrastre hacia la posición deseada</li>
                  {/* <li>
   ...
   return (
      <List.Item
         actions={[
            ...
            // />,
            <Button type="primary" title="Editar" onClick={() => editHorarioModal(item)}>
               <EditOutlined />
            </Button>,
            <Button type="danger" title="Eliminar" onClick={() => deleteHorario(item)}>
               <DeleteOutlined />
            </Button>,
         ]}
      >
