...
export default function ReportarError(props) {
   ...
   return (
      <div className="reportar-error">
         <h1>DESARROLLO29</h1>
         <p style={{ textAlign: "center" }}>Web App desarrollada por Desarrollo29</p>
         <div className="reportar-error__info">
            ...
            <ul>
               ...
               <li>
                  ...
                  <span style={{ fontStyle: "italic" }}>tunombre@tuparroquia.com</span> (Outlook y/o
                  Gmail)
               </li>
               <li>
            ...
            <ul>
               <li>Cómo usar la Plataforma de Desarrollo29 para tu negocio</li>
               <li>Cómo sacarle provecho a Whatsapp Business</li>
               <li>Cómo crear Formularios de Google para registro de Eventos</li>
               <li>
                  Cómo hacer videollamadas para eventos por Zoom, Microsoft Teams y Google Meet
               </li>
               <li>Cómo usar Google Drive para respaldo de archivos, fotos, videos...</li>
               <li>
                  Cómo usar la nube de Google para documentos colaborativos y evitar el envío de
                  mails con archivos
               </li>
               <li>Capacitación Suite de Office: Excel, Word, PowerPoint, Outlook </li>
               <li>
         ...
         <Form labelCol={{ span: 4 }} onFinish={sendMessage}>
            ...
            <p>
               Para <strong>reportar un error</strong> <br />o para contactarte con Desarrollo 29
            </p>
            ...
            >
               <Input
                  ...
                  onChange={(e) => setMessageData({ ...messageData, nombre: e.target.value })}
               />
            </Form.Item>
            <Form.Item label="Teléfono">
               <Input
                  ...
                  onChange={(e) => setMessageData({ ...messageData, telefono: e.target.value })}
               />
            </Form.Item>
            <Form.Item label="Correo">
               <Input
                  ...
                  onChange={(e) => setMessageData({ ...messageData, correo: e.target.value })}
               />
            </Form.Item>
            <Form.Item label="Asunto">
               <Input
                  ...
                  onChange={(e) => setMessageData({ ...messageData, asunto: e.target.value })}
               />
            </Form.Item>
            ...
            >
               <Input.TextArea
                  ...
                  onChange={(e) => setMessageData({ ...messageData, mensaje: e.target.value })}
               />
            </Form.Item>
            <Form.Item>
