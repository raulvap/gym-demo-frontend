...
import AdminRegistroMisas from "../pages/Admin/RegistroMisas";
import AdminListaRegistros from "../pages/Admin/RegistroMisas/ListaRegistros";
...
import RegistroMisas from "../pages/RegistroMisas";
import ReservacionConfirmada from "../pages/RegistroExitoso";
import Intenciones from "../pages/Intenciones";
...
const routes = [
  {
    ...
    routes: [
      ...
      {
        path: "/admin/registro",
        component: AdminRegistroMisas,
        exact: true,
      },
      {
        path: "/admin/registrados",
        component: AdminListaRegistros,
        exact: true,
      },
      {
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        component: ReservacionConfirmada,
        exact: true,
      },
      {
        path: "/intenciones",
        component: Intenciones,
        exact: true,
      },
      {
